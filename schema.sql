/* source: https://resources.oreilly.com/examples/9780596007270 */
...
create table account
 (account_id serial,
  ...
  avail_balance float(12),
  pending_balance float(12),
...
CREATE TYPE transaction_type_enum AS ENUM ('DBT', 'CDT');

create table transaction
 (txn_id serial,
  txn_date date not null,
  account_id integer  not null,
  txn_type_cd transaction_type_enum,
